...
export function quotationEmailHtml(d: QuotationEmailData): string {
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border:1px solid #e2e8f0;border-radius:4px;border-top:3px solid ${ACCENT};">
        <tr><td style="padding:24px 32px 18px;border-bottom:1px solid #eef1f5;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
            ...
            <td align="right" style="font-size:11px;font-weight:700;letter-spacing:0.8px;color:#94a3b8;text-transform:uppercase;">Quotation</td>
          </tr></table>
        </td></tr>
        ...
        <tr><td style="padding:22px 32px 6px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
            <td style="vertical-align:top;">
              <div style="font-size:12px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.4px;">Quote to</div>
              <div style="margin-top:3px;font-size:15px;font-weight:700;color:#0f172a;">${esc(d.customerName) || "Customer"}</div>
            </td>
            <td align="right" style="vertical-align:top;">
              <div style="font-size:13px;color:#0f172a;font-weight:700;">#${esc(d.quoteNumber)}</div>
              <div style="font-size:12px;color:#64748b;margin-top:2px;">Date: ${prettyDate(d.quoteDate)}</div>
              ${d.validUntil ? `<div style="font-size:12px;color:#64748b;">Valid till: ${prettyDate(d.validUntil)}</div>` : ""}
            </td>
          </tr></table>
        </td></tr>
        ...
        <tr><td style="padding:18px 32px 26px;">
          <p style="margin:0;color:#475569;font-size:14px;line-height:1.65;">
            Thank you for the opportunity. ${d.validUntil ? `This quotation is valid until <strong style="color:#0f172a;">${prettyDate(d.validUntil)}</strong>. ` : ""}To accept or discuss, simply reply to this email.
          </p>
